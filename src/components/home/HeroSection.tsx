    ...
    return (
        <section id="home" className="relative grid grid-cols-1 border-b border-border lg:grid-cols-[1.15fr_auto_1fr]">
            ...
            <div className="flex flex-col justify-center px-6 py-8 xl:px-10 xl:py-10">
                ...
                <button className="mt-6 inline-flex w-fit items-center gap-2 bg-accent px-7 py-3 font-heading text-body tracking-wide text-background transition-opacity hover:opacity-90 xl:mt-8">
                    VIEW MY WORK
                    <span>→</span>
                </button>
            </div>
